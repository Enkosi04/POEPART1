...
class ChangePasswords
{
    public void StartChatbot()
    {
        ...
        DisplayImages(new[] { "ChangePassword.jpg" });
    ...
    {
        if (input.Contains("How often should I change my passwords", StringComparison.OrdinalIgnoreCase))
        {
            return "It is recommended to change your passwords every 3-6 months and immediately if you suspect "+
